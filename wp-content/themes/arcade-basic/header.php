			 ...
			 <div class="title-card-wrapper">
                <div class="title-card">
    				<div id="site-meta">
    					...
    					<i href="/" style="background-image: url(http://24.media.tumblr.com/avatar_f64baabeecc9_128.png)" class="fa user-avatar"><img src="http://24.media.tumblr.com/avatar_f64baabeecc9_128.png" alt="" class="invisible"></i>
    					<?php } else {
